/**
 * API Routes - REST endpoints for the mobile application
 * 
 * These are simple REST endpoints that the mobile app calls.
 * They internally trigger Beckn protocol flows.
 */
